      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Card title="Total Assets" value="$87,743" />
...
// crypto price
const CryptoCard = ({ name, price, change }: { name: string; price: number; change: string }) => (
  <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md flex flex-col items-center justify-center">
    ...
    <p className="text-xl font-bold text-gray-900 dark:text-gray-100">${price}</p>
