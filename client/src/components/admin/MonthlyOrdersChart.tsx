import {
  ...
  // ✅ Apply assetId slicing in data transformation
  ...
  const MonthlyOrdersChart = ({ rawData }: MonthlyOrdersChartProps) => {
    ...
    // ✅ Compute total across 12 months
    ...
    return (
      <div className="bg-gray-800 p-6 rounded-xl shadow-md mb-6">
        <div className="mb-2">
          ...
          <h3 className="text-gray-200">Yearly Orders by Month</h3>
        </div>
