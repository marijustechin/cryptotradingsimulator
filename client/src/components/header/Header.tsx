...
export const Header = () => {
  ...
  return (
    <>
      <div
        className={`container flex md:grid md:grid-cols-[1fr_2fr_3fr] lg:grid-cols-3 items-center justify-between z-50 h-[10vh]${
